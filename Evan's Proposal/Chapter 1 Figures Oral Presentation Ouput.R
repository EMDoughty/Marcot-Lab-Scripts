...
#K=5
#if(interval.type %in% "bins") load("/Users/emdoughty/Dropbox/Code/R/Results/2Ma Interval/JenksBreaks/BM_handleyResult_ungulates_Jenksk=5_this.rank=species_timebin=2Mabins_start=66_end=0_SampleStandardized=TRUE_Reps=1000Jonathans_MBP.lan##------ Wed Apr 13 23:59:25 2022 ------##.Rdata")
#k = 6
#if(interval.type %in% "bins") load("/Users/emdoughty/Dropbox/Code/R/Results/2Ma Interval/JenksBreaks/BM_handleyResult_ungulates_Jenks_k=6this.rank=species_timebin=2Mabins_start=66_end=0_SampleStandardized=TRUE_Reps=1000Jonathans_MBP.lan##------ Thu Apr 14 01:12:07 2022 ------##.Rdata")

#countCube_ung <- countCube
optList_bm_median_ung <- optList_bm_median
optList_bm_allReps_ung <- optList_bm_allReps
taxCubeHerb <- sapply(repIntTaxa, function(y) sapply(y, function(x) tabulate(match(bigList$family[as.character(bigList$accepted_name) %in% x], shortFam), nbins=length(shortFam)), simplify="array"), simplify="array")
dimnames(taxCubeHerb) <- list(shortFam, rownames(intervals), NULL)
...
#K=2
#if(interval.type %in% "bins") load("/Users/emdoughty/Dropbox/Code/R/Results/2Ma Interval/JenksBreaks/BM_handleyResult_carnivores_Jenks_k=2_allCateg_this.rank=species_timebin=2Mabins_start=66_end=0_SampleStandardized=TRUE_Reps=1000Jonathans_MBP.lan##------ Thu Apr 14 09:49:20 2022 ------##.Rdata")
#K=5
#if(interval.type %in% "bins") load("/Users/emdoughty/Dropbox/Code/R/Results/2Ma Interval/JenksBreaks/BM_handleyResult_carnivores_jenks_k=5_allCateg_this.rank=species_timebin=2Mabins_start=66_end=0_SampleStandardized=TRUE_Reps=1000Jonathans_MBP.lan##------ Thu Apr 14 10:21:48 2022 ------##.Rdata")
#k = 6
#if(interval.type %in% "bins") load("/Users/emdoughty/Dropbox/Code/R/Results/2Ma Interval/JenksBreaks/BM_handleyResult_carnivores_jenks_k=6_allCateg_this.rank=species_timebin=2Mabins_start=66_end=0_SampleStandardized=TRUE_Reps=1000Jonathans_MBP.lan##------ Thu Apr 14 10:54:00 2022 ------##.Rdata")

optList_bm_median_pred <- optList_bm_median
optList_bm_allReps_pred <- optList_bm_allReps
taxCubePred <- sapply(repIntTaxa, function(y) sapply(y, function(x) tabulate(match(bigListPred$family[as.character(bigListPred$accepted_name) %in% x], shortFamPred), nbins=length(shortFamPred)), simplify="array"), simplify="array")
dimnames(taxCubePred) <- list(shortFamPred, rownames(intervals), NULL)
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Species Richness Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
     width = 8, height = 9, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Species Richness Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 9, units = "in", res = 200)
}
...
axis(1,col.ticks="white", col.axis = "white", cex.axis =2, labels = FALSE, at = c(seq(0,65,by = 5)), lwd = 2, tck = -0.05, las = 1, padj = 1.5)
axis(2,col.ticks="white", col.axis = "white", cex.axis =2, labels = TRUE, at = c(seq(0,100,by = 20)), lwd = 2, tck = -0.05, las = 1, hadj = 1.5)
...
plotStackedRichness(this.box=prop_herb/rowSums(prop_herb), intervals=intervals, reorder.taxa = FALSE, do.log=FALSE, 
                    ...
                    overlay.labels = FALSE, overlay.color = TRUE, do.subepochs = TRUE, thisAlpha.text = 0.75, borderCol = "black", invertTime = FALSE, scale.cex = 1.25, scale.headers = 0.90, text.offset = 0.05)
axis(1,col.ticks="white", col.axis = "white", cex.axis =2, labels = FALSE, at = c(seq(0,65,by = 5)), lwd = 2, tck = -0.05, las = 1, padj = 1.5)
axis(2,col.ticks="white", col.axis = "white", cex.axis =2, labels = TRUE, at = c(seq(0,1,by = 0.2)), lwd = 2, tck = -0.05, las = 1, hadj = 1.5)
...
plotStackedRichness(this.box=prop_pred/rowSums(prop_pred), intervals=intervals, reorder.taxa = FALSE, do.log=FALSE, 
                    ...
                    xlim = c(65,  min(intervals, na.rm=TRUE)), ylim = c(0, 1.2), xaxp = c(65, 0, 13), yaxp = c(0, 1, 5),
                    overlay.labels = FALSE, overlay.color = TRUE, do.subepochs = TRUE, thisAlpha.text = 0.75, borderCol = "black", invertTime = FALSE, scale.cex = 1.25, scale.headers = 0.90, text.offset = 0.05)
axis(1,col.ticks="white", col.axis = "white", cex.axis =2, labels = TRUE, at = c(seq(0,65,by = 5)), lwd = 2, tck = -0.05, las = 1, padj = 0.75)
axis(2,col.ticks="white", col.axis = "white", cex.axis =2, labels = TRUE, at = c(seq(0,1,by = 0.2)), lwd = 2, tck = -0.05, las = 1,hadj = 1.5)
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Species Richness Plots for Pred Diet Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Large Herbivore Plots Draft 2 Ma Intervals 64 to 0 Ma", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley nalysis Large Herbivore Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

par(mfrow = c(1,1), mar=c(3,3,0.5,0), mgp=c(2, 0.75 ,0), oma = c(0,1,0,1), bg = NA) #mfrow = c(8,1),
shoulderPlot(measure.mat = measure.mat, plot.y = "bodyMass", intervals = intervals, occs = occs, this.rank = "species", 
             ...
             do.quants = TRUE,
             col.axis = "white", col.lab = "white", poly.col = "deepskyblue4", median.col = c("darkturquoise", "deepskyblue4", "deepskyblue1"))
axis(1,col.ticks="white", col = "white", col.axis = "white", cex.axis =2, labels = FALSE, at = c(-10, seq(0,65,by = 5), 75), lwd = 2, tck = -0.05, las = 1, padj = 0.75)
axis(2,col.ticks="white", col = "white", col.axis = "white", cex.axis =2, labels = FALSE, at = c(-5,seq(0,4,by = 1), 10), lwd = 2, tck = -0.05, las = 1,  hadj = 1.5)

dev.off()

if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Predator Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley nalysis Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
shoulderPlot(measure.mat = pred.data, plot.y = "bodyMass", intervals = intervals, occs = occs, this.rank = "species", 
             ...
             overlay.labels = FALSE, overlay.color = TRUE, do.subepochs = TRUE, thisAlpha.text = 0.75, borderCol = "black", invertTime = FALSE, scale.cex = 0.75, scale.headers = 0.90, text.offset = 0.05,
             do.quants = TRUE,
             col.axis = "white", col.lab = "white", poly.col = "darkorange4", median.col = c("goldenrod1", "darkorange4", "darkorange1"))
axis(1,col.ticks="white", col = "white", col.axis = "white", cex.axis =2, labels = FALSE, at = c(-10, seq(0,65,by = 5), 75), lwd = 2, tck = -0.05, las = 1, padj = 0.75)
axis(2,col.ticks="white", col = "white", col.axis = "white", cex.axis =2, labels = FALSE, at = c(-5,seq(-1,4,by = 1), 10), lwd = 2, tck = -0.05, las = 1,  hadj = 1.5)
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hypercarnivores Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hypercarnivores Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Mesocarnivores Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paaste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Mesocarnivores Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hypocarnivores Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hypocarnivores Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hyper_Meso Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hyper_Meso Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hyper_Hypo Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Hyper_Hypo Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Meso_Hypo Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Handley Analysis Meso_Hypo Predator Plots Draft NALMA ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Large Herbivore Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Large Herbivores Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist All predator Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist All predator Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hypercarnivores Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hypercarnivores Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Mesocarnivores Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Mesocarnivores Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hypocarnivores Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hypocarnivores Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hyper_Meso Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hyper_Meso Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hyper_Hypo Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Hyper_Hypo Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Meso_Hypo Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Regime BMdist Meso_Hypo Draft NALMA ", date.save,".png"),
      width = 9, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices All predator 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices All predator Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hypercarnivore 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hypercarnivore Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Mesocarnivore 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Mesocarnivore Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hypocarnivore 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hypocarnivore Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hyper and Mesocarnivores 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hyper and Mesocarnivores Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hyper and Hypocarnivores 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Hyper and Hypocarnivores Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Meso and Hypocarnivores 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}

if(interval.type == "nalma")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Correlation Matrices Meso and Hypocarnivores Draft NALMA ", date.save,".png"),
      width = 7, height = 3, units = "in", res = 200)
}
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Taxonomic Richness Herbivores Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
prop <- t(apply(taxCubeHerb, c(1,2), mean, na.rm=TRUE))
...
par(mfrow = c(1,1), mar=c(3,3,0.5,0), mgp=c(2, 0.75 ,0), oma = c(0,1,0,1), bg=NA) #mfrow = c(8,1),
plotStackedRichness(this.box=prop, intervals=intervals, reorder.taxa = FALSE, do.log=FALSE, 
                    numbers.only=FALSE, add.legend=FALSE, 
                    col.axis = "white", col.lab = "white", xaxt = 'n', yaxt = 'n',
                    cex.axis = 1.5, cex.lab = 1, las = 1,
                    ylab = "", #"Species Richness (Number of Subtaxa)",
                    xlim = c(65, min(intervals, na.rm=TRUE)), ylim = c(0, max(rowSums(prop))+20), xaxp = c(65, 0, 13), yaxp = c(0, 120, 6),
                    overlay.labels = FALSE, overlay.color = TRUE, do.subepochs = TRUE, thisAlpha.text = 0.75, 
                    borderCol = "black", invertTime = FALSE, scale.cex = 1, scale.headers = 0.90, text.offset = 0.05)
axis(1,col.ticks="white", col.axis = "white", cex.axis =1, labels = FALSE, at = c(seq(0,65,by = 5)), lwd = 2, tck = -0.05, las = 1, padj = 1.5)
axis(2,col.ticks="white", col.axis = "white", cex.axis =1, labels = TRUE, at = c(seq(0,100,by = 20)), lwd = 2, tck = -0.05, las = 1, hadj = 1.5)
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Taxonomic Richness Herbivores Legened Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
...
par(mfrow = c(1,1), mar=c(3,3,0.5,0), mgp=c(2, 0.75 ,0), oma = c(0,1,0,1), bg=NA) #mfrow = c(8,1),
plotStackedRichness(this.box=prop, intervals=intervals, reorder.taxa = FALSE, do.log=FALSE, 
                    numbers.only=FALSE, add.legend=TRUE, 
                    col.axis = "white", col.lab = "white", xaxt = 'n', yaxt = 'n',
                    cex.axis = 1.5, cex.lab = 1, las = 1,
                    ylab = "", #"Species Richness (Number of Subtaxa)",
                    xlim = c(65, min(intervals, na.rm=TRUE)), ylim = c(0, max(rowSums(prop))+20), xaxp = c(65, 0, 13), yaxp = c(0, 120, 6),
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Taxonomic Richness Predators Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 2.75, units = "in", res = 200)
}
...
# prop <- t(apply(taxCube, c(1,2), median, na.rm=TRUE))
prop <- t(apply(taxCubePred, c(1,2), mean, na.rm=TRUE))
colnames(prop)[colnames(prop)==""] <- "indeterminate"
# dimnames(prop) <- list(rownames(intervals), shortFam)
#source("https://dl.dropbox.com/s/iy0tu983xesbig2/taxonomicEv.R")
...
plotStackedRichness(this.box=prop, intervals=intervals, reorder.taxa = FALSE, do.log=FALSE, 
                    ...
                    borderCol = "black", invertTime = FALSE, scale.cex = 1, scale.headers = 0.90, text.offset = 0.05)
axis(1,col.ticks="white", col.axis = "white", cex.axis =1, labels = FALSE, at = c(seq(0,65,by = 5)), lwd = 2, tck = -0.05, las = 1, padj = 1.5)
axis(2,col.ticks="white", col.axis = "white", cex.axis =1, labels = TRUE, at = c(seq(0,50,by = 10)), lwd = 2, tck = -0.05, las = 1, hadj = 1.5)
...
if(interval.type == "bins")
{
  png(paste0("/Users/emdoughty/Dropbox/Proposal/Chapter 1 Figures/Taxonomic Richness Predators Legened Plots Draft 2 Ma Intervals 64 to 0 Ma ", date.save,".png"),
      width = 8, height = 6, units = "in", res = 200)
}
